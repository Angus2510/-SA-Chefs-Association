...
export const candidates: Candidate[] = [
  ...
  },
  {
    ...
    imageUrl: "/Mahlomola-Thamae.jpg",
  },
  {
    id: "6",
    name: "Manfred Muellers",
    bio: "Manfred Muellers is Life-Honorary Member of the World Association of Chefs Societies, Life-Honary President of the South African Chefs Association, and of the Confrèrie de la Chaîne des Rôtisseurs (Paris), as well as Delegate Ambassador to the Advisory Council of the UN accredited The World Gastronomic Institute, a founder member of South African chapter of Chaîne des Rôtisseurs; has been inducted into the prestigious South African Academy of Chefs (founder member) and the German Gastronomic Academy. He is a Fellow of many international management and culinary organisations, honorary life member of the World Master Chefs Society, and is past International Board Director of Les Toques Blanches. Manfred has been involved in education and training development for 38 years, as Senior Lecturer at the School of Tourism and Hospitality at the University of Johannesburg; and as consultant to a number of private training schools; and served as advisory member of the following Committees: Gauteng Regional Operating Board (THETA), Committee Hotel Industry Training Board SA (THETA), Executive Management Committee Federated Hotel Association of South Africa (FEDHASA), University of Johannesburg, Ethics Committee (Research). In addition, Manfred authors articles relating to the Hotel and Catering Industry and is Editorial Adviser to leading trade magazines and publications in South Africa, since 1977; and in Germany. A perpetual over-achiever and pioneer, Manfred pushes the boundaries of Cuisine whilst drawing upon and defending the Classics.",
    imageUrl: "/Manfred-Muellers.jpg",
  },
  {
    id: "7",
    name: "Pieter Malan",
